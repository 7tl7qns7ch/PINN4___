...
class NavierStokes2d(object):
    ...
    def advance(self, w, f=None, T=1.0, Re=100, adaptive=True, delta_t=1e-3, prevent_energy_accumulation=False, drag_scale=0.1):
        ...
        if prevent_energy_accumulation:
            f_h = f_h - drag_scale * w_h
